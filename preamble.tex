...
\title{
	...
	Tercera Práctica Dirigida\quad Grupo N$^{\circ}$2
}
...
\titlegraphic{
	\begin{picture}(0,0)
		\put(-130,80){\makebox(0,0)[rt]{\href{https://www.overleaf.com/read/qvgbhkdrcxvc}{\includegraphics[width=2.5cm]{overleaf}}}}
